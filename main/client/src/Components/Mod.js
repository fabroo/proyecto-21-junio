                            ...
                            <table className="table table-hover text-center table-responsive-lg">
                                ...
                                <tbody>
                                    ...
                                    <tr key={user._id}>
                                        ...
                                        <td>{user.createdAccount ? <img className="img-fluid" style={{ width: '100px' }} src={'http://192.168.0.109:5000\\user\\pfp\\' + user.companyID + '\\' + user.dni} alt={user.username} /> : (<p>no creada</p>)}</td>
